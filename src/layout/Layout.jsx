...
export default function Layout({children, data}) {
    const parentData = data.filter(item => item.parent_id === 0 && item.type === "header")
    const subData = data.filter(item => item.parent_id != 0 && item.type === "header")
    const footerParentData = data.filter(item => item.parent_id === 0 && item.type === "footer")
    const footerSubData = data.filter(item => item.parent_id != 0 && item.type === "footer")
    ...
    return (
        <>
            <nav className="navbar-custom">
                <section className="main-nav">
                    <div className="d-flex justify-content-center align-items-center h-100">
                        <Link href={"/"}>
                            <img src="/img/logo.png" alt="Hanousa"/>
                        </Link>
                    ...
                    <div className="svg-header pe-md-5">
                        ...
                        {userData.user_id ?
                            <>
                                <Box sx={{display: 'flex', alignItems: 'center', textAlign: 'center'}} className={"d-none d-md-block"}>
            ...
            <nav className="navigation-menu col-lg-3 col-md-5 col-7 shadow d-md-none bg-white" id={"navigationMenu"} ref={responsiveMenu}>
                        ...
                        <div className="sidebar-layout">
                            <div className="sidebar-header">
                                <div className="d-flex flex-column align-items-end">
                                        {userData.user_id ?
                                            <>
                                                <Box sx={{display: 'flex', alignItems: 'center', textAlign: 'center'}} className={"d-block d-md-none"}>
                                                    <Tooltip title="منوی دسترسی">
                                                        <Badge badgeContent={userData.name === null ? 1 : 0} color="error">
                                                            <IconButton
                                                                onClick={handleClick}
            ...
            <footer className="footer position-relative">
                <div className="container top-footer">
                    <div className="row pt-3">
                        <div className="col-12 offset-3 offset-md-0 col-md-4 mt-4 mt-md-0">
                        ...
                        <div className="col-12 offset-3 offset-md-0 col-md-4">
                            <img className="img-logo" src="/img/logo-2-1.png" alt="logo"/>
                        </div>
            ...
            <div className="copyright">
                <div className="copy-text">
                    <p>تمامی حقوق این وبسایت متلق به ما میباشد &copy;</p>
                </div>
